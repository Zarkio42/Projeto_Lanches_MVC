...
namespace LanchesMac_ProjMVC_Gauss.Models
{
    public class CarrinhoCompra
    {
        ...
        {
            var carrinhoCompraItem = _context.CarrinhoCompraItens.SingleOrDefault(s => s.Lanche.LancheId == lanche.LancheId && s.CarrinhoCompraId
            == CarrinhoCompraId);
        ...
        {
            return CarrinhoCompraItems ?? (CarrinhoCompraItems = _context.CarrinhoCompraItens.Where(
